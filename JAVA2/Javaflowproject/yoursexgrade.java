...
public class yoursexgrade {

	public static void main(String[] args) { 
	    Scanner sexgrade = new Scanner(System.in);
 
	    System.out.println("Hey,You!yes..yes you!");
	    System.out.println("지금부터 당신의 섹스 그레이드를 평가하겠습니다.");
	    System.out.print("당신의 이름을 입력해주세요.");
	    String 이름=sexgrade.nextLine();
	      
	    System.out.print(이름+"님의 현재까지의 경험 인수를 적어주세요(3명의 경우, 3이라고 입력해주세요) ");
        int 경험인수 = sexgrade.nextInt();
	          
        if(경험인수 < 0) { 
        	System.out.println("입력 오류입니다 혹은 "+이름+"님은 아직 난자와도 섹스못한 정자 수준의 사람입니다. 프로그램을 재시동해주세요.");
        }
        else if(경험인수 == 0) {
        	System.out.println(이름+"님은 아다입니다. 마법학교 호그와트에 어서오세요.쩩쮸♡");
        }
        else if (경험인수 == 1) 
        {
        	System.out.print(이름+"님이 지금까지 경험한 성매매 경험은 몇 회입니까?(3번의 경우, 3이라고 입력해주세요) " );
        
        	int 성매매경험횟수 = sexgrade.nextInt();
        	if(경험인수==1 && 성매매경험횟수>경험인수||성매매경험횟수<0) {System.out.println("개소리 말고 재기동해서 다시 작성하세요.");}
        	else if(경험인수== 1 && 성매매경험횟수==0) {System.out.println(이름+"님은 자라나는 섹린이입니다. 어서 밖으로 나가서 당신의 씨앗을 뿌리세요");}
        	else if(경험인수== 1 && 성매매경험횟수==1) {System.out.println(이름+"님은 반다입니다. 불완전한 섹린이이므로 얼른 연애를 통해 해결하세요");}
        }
        else if (경험인수 == 2) 
        {
        	System.out.print(이름+"님이 지금까지 경험한 성매매 경험은 몇 회입니까?(3번의 경우, 3이라고 입력해주세요) " );
        	...
        	int 성매매경험횟수 = sexgrade.nextInt();
        	if(경험인수==2 && 성매매경험횟수>경험인수||성매매경험횟수<0) {System.out.println("개소리 말고 재기동해서 다시 작성하세요.");}
        ...
        else if (경험인수 == 3) 
        {
        	...
        	int 성매매경험횟수 = sexgrade.nextInt();
        	if(경험인수==3 && 성매매경험횟수>경험인수||성매매경험횟수<0) {System.out.println("개소리 말고 재기동해서 다시 작성하세요.");}
        ...
        else if (경험인수 == 4)         
        {
        	...
        	int 성매매경험횟수 = sexgrade.nextInt();
        	System.out.println(경험인수);
        	if(경험인수==4 && 성매매경험횟수>경험인수||성매매경험횟수<0) {System.out.println("개소리 말고 재기동해서 다시 작성하세요.");}
        ...
        else if (경험인수 == 5)
        {
        	...
        	int 성매매경험횟수 = sexgrade.nextInt();
        	System.out.println(경험인수);
        	if(경험인수>=5 && 성매매경험횟수>경험인수||성매매경험횟수<0) {System.out.println("개소리 말고 재기동해서 다시 작성하세요.");}
        ...
        else if (경험인수 >=6&&경험인수<9)
        {
        	...
        	int 성매매경험횟수 = sexgrade.nextInt();
        	System.out.println(경험인수);
        	if(경험인수>=6&&경험인수<9 && 성매매경험횟수>경험인수||성매매경험횟수<0) {System.out.println("개소리 말고 재기동해서 다시 작성하세요.");}
